...
// world-atlas@2.0.2 countries-110m.json uses numeric IDs (geo.id), NOT names.
// This table maps our 2-letter country codes to numeric IDs for correct matching.
const ISO_ALPHA2_TO_NUMERIC = {
  AF:"4",AX:"8",AL:"8",DZ:"12",AS:"16",AD:"20",AO:"24",AI:"660",AQ:"10",
  ...
  SB:"090",SO:"706",ZA:"710",GS:"239",SS:"728",ES:"724",LK:"144",SD:"729",
  ...
  UM:"581",UY:"858",UZ:"860",VU:"548",VE:"862",VN:"704",VG:"092",VI:"850",
            ...
            <ComposableMap projectionConfig={{ scale: 140 }} style={{ width: "100%", height: "100%", display: "block" }}>
              <ZoomableGroup zoom={1} minZoom={1} maxZoom={8} center={[0, 20]}>
                <Geographies geography="https://unpkg.com/world-atlas@2.0.2/countries-110m.json">
                  {({ geographies }) => {
                    // Build a lookup: ISO numeric string → geo data entry
